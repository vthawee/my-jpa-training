...
/**
 * Create a Decorator class of EntityManager to implement AutoClosable
 * @author com
 */
public class MyEntityManager implements EntityManager, AutoCloseable {
    
    private EntityManager em;

    public MyEntityManager(EntityManager em) {
        this.em = em;
    }
