...
public class TestL2 {
    ...
    public static void main(String[] args) {
         ...
         * book entity is marked @Cachable(true). ALL, NONE, ENABLE_SELECTIVE,
         * DISABLE SELECTIVE, UNSPECIFIED
         */
        ...
        System.out.println(cache3.contains(Book.class, book2.getId())); // now a cache

        cache3.evictAll(); // clear cache
        props.put("javax.persistence.cache.storeMode", "BYPASS"); // no cache
        em.find(Book.class, book2.getId(), props);
        System.out.println(cache3.contains(Book.class, book2.getId())); // no cache entry
    }
}
